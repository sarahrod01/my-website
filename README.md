# Website · Meet the candidate (desktop) — design reference
...
- `WebsiteDesktop.dc.html` — the artboard (a Design Component: an `<x-dc>`
...
Serve the folder (e.g. `python3 -m http.server`) and open `WebsiteDesktop.dc.html`;
